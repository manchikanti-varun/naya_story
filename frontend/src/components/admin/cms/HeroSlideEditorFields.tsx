...
export function HeroSlideEditorFields({ slide, index, total, onUpdate, onMove }: Props) {
            ...
            <div className="grid gap-4">
              ...
              <AdminField label="Desktop image URL">
                <AdminInput
                  ...
                  onChange={(e) => onUpdate({ desktopImage: e.target.value })}
                />
              </AdminField>
              <AdminField label="Mobile image URL" hint="Optional — uses desktop image when empty.">
                <AdminInput
                  placeholder="https://…"
                  value={slide.mobileImage ?? ""}
                  onChange={(e) => onUpdate({ mobileImage: e.target.value })}
                />
              </AdminField>

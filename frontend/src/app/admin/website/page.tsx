...
const links = [
  ...
  },
  {
    ...
    title: "Legal pages",
    description: "Terms, privacy, refunds, shipping — each with its own URL and footer link.",
    icon: Shield,
  },
  {
    href: "/admin/website/footer",
    title: "Footer",
    description: "Contact, social, and brand lockup. Legal links come from Legal pages.",
    icon: LayoutGrid,
  },
  {
